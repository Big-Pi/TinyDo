...
+(NSDictionary*)dataDict{
    ...
    if(!dic){
        dic=@{@1:NSLocalizedString(@"星期一", @"星期一"),
              @2:NSLocalizedString(@"星期二", @"星期二"),
              @3:NSLocalizedString(@"星期三", @"星期三"),
              @4:NSLocalizedString(@"星期四", @"星期四"),
              @5:NSLocalizedString(@"星期五", @"星期五"),
              @6:NSLocalizedString(@"星期六", @"星期六"),
              @7:NSLocalizedString(@"星期日", @"星期日")};
    }
    return dic;
}
